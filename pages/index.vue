...
<template>
    <v-app>
        ...
        <v-container>
            <v-app-bar
                image="https://firebasestorage.googleapis.com/v0/b/boyholic-badminton.appspot.com/o/assets%2Fimages%2Fcms-kv-1.jpg?alt=media&token=11773954-eca8-4c3c-a363-3a0ab66277fb">
                <template #append>
                    <v-menu>
